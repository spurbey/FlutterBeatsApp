...
class _PlayerState extends State<OfflinePlayer>
  ...
  void initState() {
    ...
    _colorTween = _animationController.drive(ColorTween(begin: Colors.orangeAccent, end: Colors.black) as Animatable<Color>);
          ...
          children: [
            ...
            Column(
              children: <Widget>[
                ...
                Text(
                  widget.data.artist,
                  style: GoogleFonts.lato(color: Colors.white30, fontSize: 15.0),
                ),
                StreamBuilder<Duration>(
                  stream: _player.durationStream as Stream<Duration>,
